      ...
      <div class="container-fluid">
       ...
       <!-- general form elements -->
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="editbill" method="post" action="{{route('bill.update',$bill->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="card-body">
                  <div class="form-row">
                  ...
                  <div class="form-group col-lg-12">
                    ...
                    <textarea name="description" class="form-control" id="Description" rows="3" >{{$bill->description}}</textarea>
                  </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-lg-6 col-md-12">
                    ...
                    <input type="date" name="date" id="billDate" value="{{$bill->Date}}" required>
                  </div>
                  <div class="form-group col-lg-6 col-md-12">
                    <label for="dueDate">Due Date</label>
                    <input type="date" name="dueDate" id="dueDate" value="{{$bill->dueDate}}" required>
                  </div>
